            ...
            <ul class="nav" id="nav-hide">
                ...
                <li class="nav-item">
                    <a class="nav-link animated wow swing slow infinite" href="{{route('randomQuiz')}}"><i
                            class="fa fa-random text-white mr-3"></i><b>Practice Quiz</b></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <p class="animated wow fadeInDown delay-0-2s">Check out our Keen & Able online computer programming quizzes to enhance your knowledge, learn new things, or prepare for an upcoming test. Made up of well-researched and interesting quiz questions, each and every quiz here can test your awareness and grasp of the subject.
</p>
